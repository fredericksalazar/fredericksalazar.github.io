...
imagen: "/images/blog/pres2026-votos-candidato.png"
draft: false
tipo: "analisis"
destacado: false
---
...
Si quieres explorar todos los gráficos a fondo, puedes acceder al [tablero interactivo del análisis de elecciones presidenciales 2026](https://fredericksalazar.github.io/elecciones-presidenciales/2026/), donde están los mapas departamentales, las tablas por candidato y la variación del voto por tendencia.

## El país salió a votar (otra vez)

![Gráfico de barras comparando la participación electoral de la primera vuelta presidencial de Colombia entre 2022 y 2026.](/images/blog/pres2026-participacion.png)
...
![Gráfico de barras horizontales con los votos por candidato en la primera vuelta presidencial de Colombia 2026, liderado por Abelardo de la Espriella e Iván Cepeda.](/images/blog/pres2026-votos-candidato.png)
...
![Comparativo de los bloques ideológicos entre la primera vuelta presidencial de 2022 y la de 2026, mostrando dos gráficos de dona y una tabla con la variación en puntos porcentuales: la izquierda sube 0.66 pp, el centro sube 1.30 pp y la derecha baja 2.01 pp.](/images/blog/pres-ideologia-comparativo-2022-2026.png)
...
![Comparación de los mapas de ganador por departamento entre la primera vuelta de 2022 y la de 2026. En 2022 el centro del país era amarillo (Rodolfo Hernández); en 2026 ese mismo centro andino se volvió azul (Abelardo de la Espriella), mientras la periferia roja se mantiene de la izquierda (Petro en 2022, Cepeda en 2026).](/images/blog/pres-mapa-comparativo-2022-2026.png)
...
Puedes ver los mapas interactivos con el detalle de cada departamento y la variación del voto por tendencia en el [tablero del análisis presidencial 2026](https://fredericksalazar.github.io/elecciones-presidenciales/2026/).
...
![Variación porcentual del voto por tendencia política (izquierda, centro, derecha) entre la primera vuelta de 2022 y la de 2026, en cada uno de los 33 departamentos de Colombia. Tres mapas: el rojo para izquierda muestra crecimiento generalizado del +21% promedio; el verde del centro muestra un crecimiento explosivo (+52% promedio) liderado por Santander; el azul de la derecha muestra un crecimiento mucho más débil (+4.5% promedio) y desigual.](/images/blog/pres-variacion-tendencia-2022-2026.png)
