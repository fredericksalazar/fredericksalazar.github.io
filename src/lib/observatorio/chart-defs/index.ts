...
import { comparativoUzb, comparativoCog, comparativoPrt, comparativoGha, comparativoChe } from "./comparativo";
import {
  inflacionHistorica,
  pibHistorico,
...
const COMPARATIVO_DEFS: ChartDef[] = [...comparativoUzb, ...comparativoCog, ...comparativoPrt, ...comparativoGha, ...comparativoChe];
